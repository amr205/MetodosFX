...
public class UseMethod {
    public static void calculateResult(TableView table, Label resultLabel, TextField equationField, TextField solveStart, TextField solveEnd, ComboBox methodBox){
        ...
        if(isCorrect){
            ...
            float result = method.doMethod(table, initA, initB,equationField.getText());
